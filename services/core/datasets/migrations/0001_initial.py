    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("rgb", "rgb"),
                            ("multispectral", "Мультиспектральный"),
                            ("hyperspectral", "Гиперспектральный"),
                        ],
                        default="rgb",
                        max_length=32,
                ...
                ("size", models.BigIntegerField(blank=True, null=True, verbose_name="Общий размер")),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("file_format", models.CharField(max_length=32, verbose_name="Формат")),
