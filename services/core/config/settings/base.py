...
DJANGO_SUPERUSER_EMAIL = env("DJANGO_SUPERUSER_EMAIL", default="admin@paps.ru")
...
TRAINING_WORKERS = env("TRAINING_WORKERS", default=2)

CVAT_TOKEN = env("CVAT_TOKEN", default=None)
...
DATA_UPLOAD_MAX_MEMORY_SIZE = 2024 * 1024 * 1024
